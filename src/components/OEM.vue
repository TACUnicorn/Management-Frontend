  ...
  <el-main class="main">
    ...
    <el-row class="table">
      <el-table stripe :data="tableData">
        <el-table-column prop="materialName" label="Product" align="center" >
        </el-table-column>
        <el-table-column prop="amount" label="Number" align="center"></el-table-column>
        <el-table-column prop="time" label="Time" align="center"></el-table-column>
        <el-table-column prop="oem" label="OEM" align="center"></el-table-column>
...
<script>
  ...
  export default {
    ...
    created: function () {
      ...
      this.$http.get("http://10.0.1.2:8000/oem/order")
        .then(response=>{
